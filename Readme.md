...
* Студент: [Неопознанный Квокка](https://up.htmlacademy.ru/htmlcss/36/user/475753).
* Наставник: `Неизвестно`.ввввв

---

_Не удаляйте и не обращайте внимание на файлы:_<br>фафыаф
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/475753-sedona-36) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
